...
local sets = {
	...
	Idle_Priority = {
		...
		Ear1 = 'Pigeon Earring',
		Ear2 = 'Pigeon Earring',
		Body = {'Vermillion Cloak', 'Ryl.Kgt. Chainmail', 'Luisant Haubert', 'Ryl.Sqr. Chnml. +2', 'Kampfbrust'},
	...
	Tank_Priority = {
		...
		Ear1 = 'Pigeon Earring',
		Ear2 = 'Pigeon Earring',
		Body = {'Haubergeon +1', 'Ryl.Kgt. Chainmail', 'Luisant Haubert', 'Ryl.Sqr. Chnml. +2', 'Kampfbrust'},
		Hands = {'Gallant Gauntlets', 'Luisant Moufles', 'Irn.Msk. Gauntlets', 'Kampfhentzes'},
	...
	Hybrid_Priority = {
		...
		Ear1 = 'Pigeon Earring',
		Ear2 = 'Pigeon Earring',
		Body = {'Haubergeon +1', 'Luisant Haubert', 'Ryl.Sqr. Chnml. +2', 'Kampfbrust'},
	...
	SwordWS_Priority = {
		...
		Ear1 = 'Tor. Earring +1',
		Ear2 = 'Tor. Earring +1',
		Body = {'Haubergeon +1', 'Scorpion Harness', 'Luisant Haubert', 'Kampfbrust' , 'Chain Mail +1' },
		Hands = {'Luisant Moufles', 'Ryl.Sqr. Mufflers'},
		Ring1 = {'Sniper\'s Ring +1', 'Courage Ring'},
		Ring2 = 'Rajas Ring',
		Back = 'High Brth. Mantle',
		Waist = {'Life Belt', 'Brave Belt'},
		Legs = 'Republic Subligar',
		Feet = {'Luisant Sollerets', 'Kampfschuhs'}
